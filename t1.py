...
# Button(text="CHECK IN", font=('Verdana', 15, 'bold'), width=15, height=1, bg='SpringGreen4', foreground='white', command=fc.partial(click_button, nn[0])).place(x=730, y=340)
# Button(text="CHECK OUT", font=('Verdana', 15, 'bold'), width=15, height=1, bg='SpringGreen4', foreground='white', command=fc.partial(click_button, nn[0])).place(x=1170, y=340)


Button(text="CHECK IN", font=('Verdana', 15, 'bold'), width=15, height=1, bg='SpringGreen4', foreground='white', command=lambda: [click_button(nn[0]), retrive_value()]).place(x=730, y=340)
Button(text="CHECK OUT", font=('Verdana', 15, 'bold'), width=15, height=1, bg='SpringGreen4', foreground='white', command=lambda: [click_button(nn[1]), retrive_value()]).place(x=1170, y=340)
